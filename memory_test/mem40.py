...
class Memory():
    ...
    def on_init(self):
        ...
        self.image.append(pygame.image.load('pic/pic40/lamp.jpg').convert())
        self.image.append(pygame.image.load('pic/pic40/jessica.jpg').convert())
        self.image.append(pygame.image.load('pic/pic40/babian.jpg').convert())
        self.image.append(pygame.image.load('pic/pic40/ren.jpg').convert())
        self.image.append(pygame.image.load('pic/pic40/tomas.jpg').convert())
        self.image.append(pygame.image.load('pic/pic40/nut.jpg').convert())
        self.image.append(pygame.image.load('pic/pic40/rubin.jpg').convert())
        self.image.append(pygame.image.load('pic/pic40/tellus.jpg').convert())
        self.image.append(pygame.image.load('pic/pic40/cock.jpg').convert())
        self.image.append(pygame.image.load('pic/pic40/jennie.jpg').convert())

        # build up text counter values from 30 - 39
        for i in range(0,10):
            self.txt_label.append(self.myfont.render(str(i+40),1,(255,0,0)))
