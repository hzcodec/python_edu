...
class Memory():
    ...
    def on_init(self):
        ...
        self.image.append(pygame.image.load('pic/pic50/susanne.jpg').convert())
        self.image.append(pygame.image.load('pic/pic50/banana.jpg').convert())
        self.image.append(pygame.image.load('pic/pic50/coffee.jpg').convert())
        self.image.append(pygame.image.load('pic/pic50/sabel.jpg').convert())
        self.image.append(pygame.image.load('pic/pic50/tarantulla.jpg').convert())
        self.image.append(pygame.image.load('pic/pic50/knife.jpg').convert())
        self.image.append(pygame.image.load('pic/pic50/birgitta.jpg').convert())
        self.image.append(pygame.image.load('pic/pic50/snow.jpg').convert())
        self.image.append(pygame.image.load('pic/pic50/socks.jpg').convert())
        self.image.append(pygame.image.load('pic/pic50/milk.jpg').convert())

        # build up text counter values from 50 - 59
        for i in range(0,10):
            self.txt_label.append(self.myfont.render(str(i+50),1,(255,0,0)))
